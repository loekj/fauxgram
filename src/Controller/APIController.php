        ...
        */
        protected function user() {
            if ($this->method == 'POST') {
                ...
                # Encrypt password using Blowfish "$2a$"
                ...
                # Get thumbnail images and comments of email
        ...
        */
         protected function img() {
            if ($this->method == 'PUT') {
                ...
                # Check if url is valid and has OK status code
                ...
                # Extract file syze and type from header using regex
                $file_size = 0;
                ...
                # Extract extension from name if not found in header
                if (!isset($ext)) {
        ...
        */
         protected function comment() {
            ...
            if ($this->method == 'POST') {
                ...
                # Get username (email) from photo owner
                ...
                # Get emails that need to be notified
                # for following thread, excludes owner itself
                $email_array = array();
